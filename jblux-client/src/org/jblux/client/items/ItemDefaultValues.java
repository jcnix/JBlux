...
public class ItemDefaultValues {
    ...
    public static final short m_requiredFactionStanding = 0;
    ...
    public static final short m_requiredDisenchantSkill = -1;
    public static final short m_armorDamageModifier = 0;
}
