...
public class Maps {
    private final String LAYOUT = "maps/layout.txt";
    ...
    public GameMap getMap(Relation rel, String current_map) {
        GameMap map = null;
        try {
            int index;
            ...
            while ((line = reader.readLine()) != null) {
                if(line.contains(current_map)) {
                    ...
                    map = getMap(rel, line, last_line, index);
                }
                else {
                    last_line = line;
                }
    ...
    private GameMap getMap(Relation rel, String line, String last_line, int index) {
        GameMap map = null;
        String name = "";
