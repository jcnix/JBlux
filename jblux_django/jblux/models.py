...
class Quest(models.Model):
    ...
    rewarditem2 = models.ForeignKey('Item', null=True, blank=True, related_name='reward_item2')
    rewarditem2_count = models.IntegerField(null=True, blank=True)
    rewarditem3 = models.ForeignKey('Item', null=True, blank=True, related_name='reward_item3')
    rewarditem3_count = models.IntegerField(null=True, blank=True)
